...
```{r}
#| code-fold: true
#| fig-cap: 'Box-Cox transformation of monthly airline passengers'
par(mfrow=c(1,2),mar=c(4, 4, 3, 1))
library(fabletools,quietly=TRUE,warn.conflicts=FALSE)
...
```{r}
library(tseries,quietly=TRUE,warn.conflict=FALSE)
