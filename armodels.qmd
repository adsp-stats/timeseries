...
For some $\phi \in \mathbb{R}$ and all $t \in T$, then we say that $\boldsymbol{Y}$ is an **autoregressive model with order 1**
:::
...
plot(10+ar,type='s',lwd=2,ylim=c(-10,25))
lines(w,type='h',col='#0000ff',lwd=2)
abline(h-10,lty=2,col='#7f7f7f')
