 ...
 * The iris specimens might have been gathered from one end of the field to the other, in a manner which correlates with the sunlight they received, or they might have been stored in boxes macthing their size, so that large irises tend to share similar measurement times.
 ...
 * If we are comparing two different time periods, you might see $t$ and $s$ used as index values.
