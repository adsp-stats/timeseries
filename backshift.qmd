...
$$\begin{aligned} & \, Y_t = 1.3\,Y_{t-1} - 0.36\,Y_{t-2} + \omega_t \\ \\ \Longrightarrow & \,Y_t = 1.3\,B\,Y_t - 0.36\,B^2\,Y_t + \omega_t \\ \\ \Longrightarrow & \, Y_t = Y_t(1.3B - 0.36B^2) + \omega_t \\ \\ \Longrightarrow & \,\omega_t = Y_t(1 - 1.3B + 0.36B^2)  \end{aligned}$$
