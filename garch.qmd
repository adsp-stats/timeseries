 ...
 * A GARCH(q,2) process may fit large datasets better in cases where some information decays quickly and other information decays slowly, such short-term oil price/supply shocks and long-term demand volatility. The two different GARCH terms will allow for a mix of two different time-decaying signals.^[I mentioned large datasets because with small datasets it's difficult to disambiguate the two effects.]
 ...
 * Stronger `beta1` and especially `beta2`, indicating one or two decaying sets of weights on past volatility, one short-term (`beta1` decays to about 1\% when compounded four times), and the other medium-term (`beta2` decays to about 1\% when compounded ten times).
